...
public class ToDoRestGetActionTests extends OpenSearchTestCase {
    private String path;
    private String requestBody;
    private ToDoRestGetAction toDoRestGetAction;
    ...
    public void setUp() throws Exception {
        ...
        this.toDoRestGetAction = new ToDoRestGetAction();
    }

    public void testGetNames() {
        String name = toDoRestGetAction.getName();
        assertEquals("todo_plugin_document_get", name);
    }

    public void testGetRoutes() {
        List<RestHandler.Route> routes = toDoRestGetAction.routes();
    ...
    public void testPrepareRequest() throws IOException {
        ...
        this.toDoRestGetAction.prepareRequest(request, Mockito.mock(NodeClient.class));
